...
//    private static String url = "jdbc:oracle:thin:@//192.168.1.46:1521/pora12c1.lecent.domain";//链接url
//    private static String username = "prison_root"; //用户名.需要设置默认表空间哈
//    private static String password = "lecent123"; //密码
//    private static String schema = "prison_business_data"; //目标数据库名

    private static String url = "jdbc:oracle:thin:@//192.168.1.46:1521/pora12c1.lecent.domain";//链接url
    private static String username = "shopping_data"; //用户名.需要设置默认表空间哈
    private static String password = "lecent123"; //密码
    private static String schema = "shopping_data"; //目标数据库名
    //查询所有表的sql语句
    ...
    public static void main(String[] args) throws Exception {
        ...
        RtfWriter2.getInstance(document, new FileOutputStream("/mnt/document/word.doc"));
        document.open();
        //查询开始
